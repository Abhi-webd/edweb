...
function Header(){
  ...
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
      <a className="mr-5 hover:text-gray-900">First Tutor Jobs</a>
      <a className="mr-5 hover:text-gray-900">Find Tutor</a>
  <div className="home-dropdown">
    <button className="home-dropbtn">Login
      <i className="fa fa-caret-down"></i>
    </button>
    <div className="home-dropdown-content">
    <Link to = '/login' className="mr-5 hover:text-gray-900"> Student</Link>
    <Link to = '/login' className="mr-5 hover:text-gray-900"> Teacher</Link>
    </div>
  </div> 
